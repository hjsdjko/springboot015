 ...
 */
@TableName("yaoganyingxiang")
public class YaoganyingxiangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YaoganyingxiangEntity() {
		
	}
	
	public YaoganyingxiangEntity(T t) {
		try {
	...
	private String yingxiangmingcheng;
	 ...
	 * 设置：影像名称
	 */
	public void setYingxiangmingcheng(String yingxiangmingcheng) {
		this.yingxiangmingcheng = yingxiangmingcheng;
	}
	/**
	 * 获取：影像名称
	 */
	public String getYingxiangmingcheng() {
		return yingxiangmingcheng;
	}
	/**
	 * 设置：图片
	 */
